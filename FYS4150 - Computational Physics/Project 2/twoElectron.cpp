...
int main(int argc, char const *argv[]) {
    ...
    arma_eigval.save("Results/E2arma_eigval", arma_ascii);
    arma_eigvecs.save("Results/E2arma_eigvecs", arma_ascii);
    ...
    jacobi_eigvals.save("Results/E2jacobi_eigval", arma_ascii);
    jacobi_eigvecs.save("Results/E2jacobi_eigvecs", arma_ascii);
