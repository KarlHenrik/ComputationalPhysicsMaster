...
int main(int argc, char const *argv[]) {
    ...
    arma_eigval.save("Results/1Earma_eigval", arma_ascii);
    arma_eigvecs.save("Results/1Earma_eigvecs", arma_ascii);
    ...
    jacobi_eigvals.save("Results/1Ejacobi_eigval", arma_ascii);
    jacobi_eigvecs.save("Results/1Ejacobi_eigvecs", arma_ascii);
